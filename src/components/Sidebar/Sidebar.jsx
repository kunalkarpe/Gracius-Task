...
//                     <Link to={"/dashboard"} className="flex gap-2 items-center text-sm hover:text-white text-white/60">
...
//                         const hasSubMenu = sideUnit?.children
//                         const ICON = sideUnit?.icon
//                         return (
//                             <div className="text-sm" key={sideUnit?.label}>
//                                 {!hasSubMenu ? (
//                                     <Link to={sideUnit?.path} className="flex gap-2 items-center hover:text-white text-white/60">
//                                         <ICON className="size-4 " /> {sideUnit?.label}
//                                     </Link>
//                                 ) : (
//                                     <Disclosure>
//                                         <DisclosureButton className="py-2 flex justify-between w-full gap-2 items-center text-white group">
...
//                                                         key={childUnit?.label}
//                                                         to={childUnit?.path}
//                                                         className="flex gap-2 items-center hover:text-white hover:bg-white/60 text-white/60 py-2 ps-6"
//                                                     >
